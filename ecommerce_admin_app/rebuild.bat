@echo off
REM Complete rebuild script for fixing image picker (Windows)
...
REM Step 3: Clear app data
echo.
echo Step 3: Clearing app from device...
adb shell pm clear com.example.ecommerce_admin_app 2>nul
echo [OK] App cleared (if connected)

REM Step 4: Rebuild and run
echo.
...
echo    flutter logs -v | find "ImagePicker"
echo.
pause
